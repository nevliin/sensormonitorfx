...
public class IO {
    ...
    private String columns = "(TIME TIMESTAMP NOT NULL, ROWID INT, SENSORID INT NOT NULL, SENSORTYPE CHARACTER(30) NOT NULL, TEMPERATURE INT, PRESSURE INT, REVOLUTIONS INT);";
